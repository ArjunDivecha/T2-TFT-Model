...
def main():
    ...
    ap.add_argument('--output_dir', type=str, default='output_F1_external_config_5', help='Directory to save all outputs (predictions, plots, models).')
    ap.add_argument('--out_xlsx', type=str, default='predictions_f1_external_config_5.xlsx', help='Output Excel file name (relative to output_dir).')
    ap.add_argument('--out_pdf', type=str, default='performance_f1_external_config_5.pdf', help='Output PDF file name (relative to output_dir).')
