...
def main():
    ...
    ap.add_argument('--output_dir', type=str, default='output', help='Directory to save all outputs (predictions, plots, models).')
    ap.add_argument('--out_xlsx', type=str, default='predictions_f1.xlsx', help='Output Excel file name (relative to output_dir).')
    ap.add_argument('--out_pdf', type=str, default='performance_f1.pdf', help='Output PDF file name (relative to output_dir).')
