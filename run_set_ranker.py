...
def main():
    ...
    ap.add_argument('--out_xlsx', type=str, default='/Users/macbook2024/Dropbox/AAA Backup/A Working/junk5/set_ranker_outputs.xlsx')
    ap.add_argument('--out_pdf', type=str, default='/Users/macbook2024/Dropbox/AAA Backup/A Working/junk5/set_ranker_plots.pdf')
    ...
    ap.add_argument('--models_dir', type=str, default='/Users/macbook2024/Dropbox/AAA Backup/A Working/junk5/models', help='Directory to save models')
    ...
    for test_t in pbar_oos:
        ...
        model = TemporalSetRanker(n_factors=M, input_size=F_in, k_history=k_hist, gru_hidden=args.hidden, n_heads=args.heads, d_model=args.hidden, emb_dim=args.emb_dim, dropout=0.1).to(device)
        ...
        if args.save_models:
            model_path = f"{args.models_dir}/model_month_{test_t:03d}.pt"
            model_info = {
    ...
    write_outputs_xlsx(
        args.out_xlsx, data.dates, data.factor_names,
    ...
    write_plots_pdf(args.out_pdf, data.dates, all_metrics, all_metrics_raw, all_metrics_iso)
